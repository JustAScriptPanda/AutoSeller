...
__all__ = ("Collectible", "PermissionDeniedError")


class PermissionDeniedError(Exception):
    """Raised when the API returns 403 Forbidden while trying to sell a collectible."""
    pass
        ...
        try:
            async with auth.patch(
                ...
                if response.status == 200:
                    ...
                    raise PermissionDeniedError("You don't have permission to sell this item")
                else:
                    return response
